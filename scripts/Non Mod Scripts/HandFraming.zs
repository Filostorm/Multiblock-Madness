...
// Credits to the Nomifactory Devs for this handframing script!
...
val sideIngredient = (<chisel:factory> | framingMaterial).marked("MatS");
val trimIngredient = (<extendedcrafting:storage:4> | framingMaterial).marked("MatT");
val frontIngredient = (<chisel:tyrian:15> | framingMaterial).marked("MatF");
