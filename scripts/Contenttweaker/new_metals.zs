...
print("==================== loading new_metals.zs ====================");
##########################################################################################

//Inert Metal
var inertcolor = Color.fromHex("B1A3C4") as Color;
var inertMetal = MaterialSystem.getMaterialBuilder().setName("Inert Metal").setColor(inertcolor).build();
...
var kanthalMetal = MaterialSystem.getMaterialBuilder().setName("Kanthal").setColor(kanthalcolor).build();
...
var ToughAlloy = MaterialSystem.getMaterialBuilder().setName("Tough Alloy").setColor(ToughAlloycolor).build();
...
var Adamantine = MaterialSystem.getMaterialBuilder().setName("Adamantine").setColor(AdamantineColor).build();
...
var Orichalcum = MaterialSystem.getMaterialBuilder().setName("Orichalcum").setColor(OrichalcumColor).build();
...
var Palladium = MaterialSystem.getMaterialBuilder().setName("Palladium").setColor(PalladiumColor).build();
