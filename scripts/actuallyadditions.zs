...
//Heat Collector
recipes.addShaped(<actuallyadditions:block_heat_collector>, [[<minecraft:iron_bars>, <tconstruct:large_plate>.withTag({Material: "bronze"}).onlyWithTag({Material: "bronze"}), <minecraft:iron_bars>],[<actuallyadditions:item_misc:7>, <actuallyadditions:item_crystal:5>, <actuallyadditions:item_misc:7>], [<minecraft:iron_bars>, <actuallyadditions:block_misc:9>, <minecraft:iron_bars>]]);
...
recipes.addShaped(<actuallyadditions:item_drill_upgrade_fortune_ii>, [[<actuallyadditions:block_crystal:1>, <minecraft:experience_bottle>, <actuallyadditions:block_crystal:1>],[<embers:gear_dawnstone>, <actuallyadditions:item_drill_upgrade_fortune>, <embers:gear_dawnstone>], [<actuallyadditions:block_crystal:1>, <arcanearchives:mindspindle>, <actuallyadditions:block_crystal:1>]]);
...
recipes.addShaped(<actuallyadditions:item_drill_upgrade_five_by_five>, [[<actuallyadditions:block_crystal:2>, <tconstruct:materials:13>, <actuallyadditions:block_crystal:2>],[<minecraft:piston>, <immersiveengineering:material:27>, <minecraft:piston>], [<actuallyadditions:block_crystal:2>, <tconstruct:materials:12>, <actuallyadditions:block_crystal:2>]]);
recipes.addShaped(<actuallyadditions:item_drill_upgrade_silk_touch>, [[<tconstruct:materials:15>, <actuallyadditions:item_crystal:2>, <tconstruct:materials:15>],[<actuallyadditions:item_crystal:2>, <rockhounding_chemistry:misc_items:1>, <actuallyadditions:item_crystal:2>], [<tconstruct:materials:15>, <actuallyadditions:item_crystal:2>, <tconstruct:materials:15>]]);
