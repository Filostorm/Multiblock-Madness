...
mods.qmd.target_chamber.addRecipe(ultimateIngot, (<particle:photon>*100000000)^18000, <contenttweaker:solar_ingot>, null, <particle:filon>, null, 22000, 0.01, 15000);
...
mods.qmd.nucleosynthesis_chamber.addRecipe(<liquid:neutronic_matrix>*36, <liquid:incoherent_matrix>*36, <particle:filon>*4998000, <liquid:neutronium>*72, null, 10000, 874000);
